...
public partial class ProfForm : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ExecuteInsert(txtFirstName, txtLastName, txtPhone, txtEmail, txtNeiuID,
                        txtPickUpDate, txtReturnDate, txtCourseName, txtProfName);
     ...
     private void ExecuteInsert(TextBox txtFirstName, TextBox txtLastName, TextBox txtPhone, 
                                ...
                                TextBox txtReturnDate, TextBox txtCourseName, TextBox txtProfName)
    {
        
        System.Data.SqlClient.SqlConnection conn = new System.Data.SqlClient.SqlConnection(GetConnectionString());
        string sql = "INSERT INTO PROFESSORFORM (first_name, last_name, phone_number, email, neiu_id_number, pickup_date, return_date, course_name, professor_name) Values"
            + "(@first_name, @last_name, @phone_number, @email, @neiu_id_number, @pickup_date, @return_date, @course_name, @professor_name)";
